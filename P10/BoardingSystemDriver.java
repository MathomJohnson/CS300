...
public class BoardingSystemDriver {
  ...
  protected void enqueuePassenger(Passenger p) {
    ...
    boolean status = boardingQueue.enqueue(p);
    if (!status) System.out.println("Boarding queue full!");
  }
  ...
  protected void startBoarding() {
    System.out.println("Start boarding!");
     ...
     System.out.println("The boarding queue contains " + this.boardingQueue.size() 
       + " passengers");
